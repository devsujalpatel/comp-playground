...
const PinSection = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative z-20 flex min-h-screen w-full items-center justify-center overflow-visible px-4 py-8 sm:px-8 md:px-12 lg:px-20"
    >
      <div
        ref={rowRef}
